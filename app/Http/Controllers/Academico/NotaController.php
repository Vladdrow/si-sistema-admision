...
class NotaController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('academico.notas.index', compact('grupos', 'semestres', 'semestreId'));
    }
    ...
    public function show(Request $request, Grupo $grupo): View
    {
        ...
        return view('academico.notas.show', compact(
    ...
    public function consulta(Request $request): View
    {
        ...
        return view('academico.notas.consulta', compact('grupos', 'semestres', 'semestreId'));
    }
    ...
    public function consultaGrupo(Request $request, Grupo $grupo): View
    {
        ...
        return view('academico.notas.consulta-grupo', compact(
