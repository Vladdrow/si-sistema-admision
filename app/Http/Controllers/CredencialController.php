...
class CredencialController extends Controller
{
    public function index(Request $request): View
    {
        ...
        if ($isAsync) {
            return view('credenciales.partials.table', compact('credenciales'));
        }
        ...
        return view('credenciales.index', compact('credenciales', 'personasSinCredencial', 'search', 'role', 'status', 'validRoles'));
    }
