...
class PersonalAdministrativoController extends Controller
{
    public function index(Request $request): View
    {
        ...
        if ($isAsync) {
            return view('personas.personal.partials.table', compact('personal'));
        }

        return view('personas.personal.index', compact('personal', 'search', 'position', 'positions', 'status'));
    }
    ...
    public function store(Request $request): RedirectResponse|JsonResponse
    {
        ...
        $result = DB::transaction(function () use ($data): array {
            $this->syncPersonalSerialSequences();
    ...
    private function syncPersonalSerialSequences(): void
    {
