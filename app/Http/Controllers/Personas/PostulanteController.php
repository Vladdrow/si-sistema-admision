...
class PostulanteController extends Controller
{
    public function index(Request $request): View
    {
        ...
        if ($isAsync) {
            return view('personas.postulantes.partials.table', compact('postulantes'));
        }

        return view('personas.postulantes.index', compact('postulantes', 'search', 'admisionStatus', 'career', 'acceso', 'statuses', 'careers'));
    }
