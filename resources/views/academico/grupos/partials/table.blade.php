...
>
    @foreach ($grupos as $grupo)
        @php $semestreFinalizado = strtolower((string) $grupo->semestre?->estado) === 'finalizado'; @endphp
        <tr>
            ...
            <td data-label="Acciones">
                <div class="actions">
                    ...
                    @if ($semestreFinalizado)
                        <button type="button" class="button secondary" disabled>Asignar horario</button>
                    @else
