...
@section('content')
    <div class="panel">
        ...
        <x-filter-panel :action="route('grupos.index')">
            <div>
            ...
            <x-slot:actions>
                <a href="{{ route('grupos.index') }}" class="button secondary" data-clear-filters>Limpiar</a>
            </x-slot:actions>
        </x-filter-panel>

        <div data-results>
            @include('academico.grupos.partials.table', ['grupos' => $grupos])
        </div>
    </div>
@endsection
