            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('password.recovery.update') }}">
                    ...
                    <div class="field">
                        ...
                        <input id="nueva_contrasena" name="nueva_contrasena" type="password" minlength="8" pattern="(?=.*[A-Z])(?=.*[0-9])(?=.*[^A-Za-z0-9]).{8,}" title="Minimo 8 caracteres, una mayuscula, un numero y un caracter especial." required>
                    </div>
