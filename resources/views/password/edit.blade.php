            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="app-modal-grid password-grid">
                    ...
                    <div class="field">
                        ...
                        <input id="nueva_contrasena" name="nueva_contrasena" type="password" autocomplete="new-password" minlength="8" required>
                    </div>
                ...
                <div class="password-guidance">
                    ...
                    <span>Use al menos 8 caracteres y evite reutilizar claves compartidas.</span>
                </div>
            ...
            <form method="POST" action="{{ route('password.recovery.update') }}" class="password-recovery-inline">
                ...
                <div class="app-modal-grid password-grid">
                    ...
                    <div class="field">
                        ...
                        <input id="nueva_contrasena_codigo" name="nueva_contrasena" type="password" autocomplete="new-password" minlength="8" required>
                    </div>
                    <div class="field">
