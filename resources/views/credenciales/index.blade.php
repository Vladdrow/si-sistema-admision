...
@section('content')
    <div class="panel">
            ...
            <form id="credential-form" data-store-url="{{ route('credenciales.store') }}">
                ...
                <div class="app-modal-grid">
                    ...
                    <div class="field">
                        ...
                        <input id="credential-password-confirmation" name="nueva_contrasena_confirmation" type="password" autocomplete="new-password">
                    </div>
                </div>
        ...
        <div id="credentials-results" data-results>
            @include('credenciales.partials.table', ['credenciales' => $credenciales])
        </div>
    </div>
@endsection
